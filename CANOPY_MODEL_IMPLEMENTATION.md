# Canopy Model Implementation Summary
...
|-----------|---------|-------------|
| `enable_canopy` | `false` | Enable canopy parameterization |
| `canopy_height` | `0.0` | Canopy height [m] |
| `frontal_area_index` | `0.0` | Frontal area index λ_f |
| `plan_area_index` | `0.0` | Plan area index λ_p |
| `canopy_drag_coeff` | `0.2` | Drag coefficient C_d |
| `use_exponential_profile` | `false` | Use Shaw-Pereira exponential decay |
| `canopy_attenuation` | `2.5` | Exponential attenuation coefficient α |

## Typical Parameter Values

### Forest Canopies

| Type | λ_f | λ_p | Height (m) |
|------|-----|-----|------------|
| Sparse forest | 0.15-0.20 | 0.10-0.15 | 10-15 |
| Moderate forest | 0.25-0.30 | 0.20-0.25 | 15-20 |
| Dense forest | 0.35-0.45 | 0.30-0.40 | 20-30 |

### Agricultural Canopies

| Type | λ_f | λ_p | Height (m) |
|------|-----|-----|------------|
| Crops | 0.10-0.15 | 0.05-0.10 | 0.5-2.0 |
| Grassland | 0.05-0.10 | 0.03-0.07 | 0.1-0.5 |

## Usage Example

```
# Enable canopy model in inputs.i
enable_canopy = true
