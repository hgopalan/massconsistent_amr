# Case 4: Yoshie Above-Roof - Yoshie Two-Layer Model (Above-Roof Level)
# Yoshie model at z > H: exponential deficit decay with height
...
# Output files
plot_file = plt_case4_yoshie_above
extract_agl = 32.0
extract_file = case4_yoshie_above.csv

# Yoshie two-layer model enabled (above-roof extraction)
