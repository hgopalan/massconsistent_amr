# AIJ Case B: Baseline - Isolated Tall Narrow Building Wake
# Standard 3H linear wake model (baseline behavior)
...
# Output files
plot_file = plt_aij_case_b_baseline
extract_agl = 15.0
extract_file = case_aij_b_extract_baseline.csv

# Baseline: all enhancements disabled (default 3H linear wake)
