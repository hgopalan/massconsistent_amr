#!/usr/bin/env python3
"""
test_cell_local_anisotropy_slope.py - Regression test for Cell-Local Spatially-Varying Anisotropy (Slope Source).
"""
...
def run_test():
    print("Initializing WindSolver with slope-only anisotropy inputs.i...")
    ...
    # Slope factor is highest on the hill sides (steepest slopes)
    # With slope-only anisotropy enabled, alpha_v will be modulated by slope
    print("✓ Slope-only anisotropy source validated")
