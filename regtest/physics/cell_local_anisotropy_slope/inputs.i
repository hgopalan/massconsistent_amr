# Spatially-Varying Variational Anisotropy Regression Test - Slope Source Only
# Tests: cell-local anisotropic adjustment based on terrain slope only
...
plot_file = plt_cell_local_anisotropy_slope
