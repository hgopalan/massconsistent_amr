# Buoyancy Default Profile Test
# Tests: Thermal stratification with buoyancy effects using default temperature profile
# Configuration: Flat terrain, no temperature file specified (falls back to default profile)
...
# Output plotfile
plot_file = plt_buoyancy_default
