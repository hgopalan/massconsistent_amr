# Spatially-Varying Variational Anisotropy Regression Test - Froude Source Only
# Tests: cell-local anisotropic adjustment based on Froude number (orographic blocking) only
...
# Only Froude number source is active
...
plot_file = plt_cell_local_anisotropy_froude
