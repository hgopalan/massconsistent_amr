# Regression test for Single Column Model (SCM) with microphysics enabled
# This test validates the SCM's ability to run with Kessler microphysics and saturation adjustment
...
scm_enable_microphysics = true # Enable SCM simple microphysics (saturation adjustment)
scm_initial_humidity = 0.8     # SCM initial relative humidity [0.0 - 1.0]
...
# OUTPUT
# ============================================================================
plot_file = plt_scm_microphysics
