# Regression test for Single Column Model (SCM) with MYJ turbulence model
# This test validates the SCM's ability to run with the MYJ model
...
scm_turbulence_model = myj      # Use MYJ boundary layer model
