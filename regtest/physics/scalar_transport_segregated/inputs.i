# 3D Scalar Transport Test (Segregated Mode)
# Tests: Segregated mode running 1 pseudo time step of wind and 3 steps of scalar transport
...
# Coupling Mode
scalar_coupling_mode = segregated
num_time_steps = 3
