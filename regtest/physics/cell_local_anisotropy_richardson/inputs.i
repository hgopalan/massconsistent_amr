# Spatially-Varying Variational Anisotropy Regression Test - Richardson Source Only
# Tests: cell-local anisotropic adjustment based on Richardson number (stability) only
...
# Only Richardson number source is active
...
plot_file = plt_cell_local_anisotropy_richardson
