#!/usr/bin/env python3
"""
test_cell_local_anisotropy.py - Regression test for Cell-Local Spatially-Varying Variational Anisotropy.
"""
...
def run_test():
    print("Initializing WindSolver with cell-local anisotropy inputs.i...")
    ...
    # is set, alpha_v will vary cell-locally.
    # Let's clean up
    solver.finalize()
    return True
