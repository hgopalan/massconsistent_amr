# Gaussian Hill Wind Solver Test with plot_fields filtering
# Tests: terrain-following mass-consistent wind with selective field output
...
# Test plot_fields with specific field selection (velocity + terrain)
# This should output only u, v, w, vel_magnitude, and terrain_z fields
plot_fields = velocity,terrain
