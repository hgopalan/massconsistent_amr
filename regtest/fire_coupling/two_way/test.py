...
Two-way coupling: wind field computed with fire heating effects. Fire heating
is extracted and fed back to wind solver for fire-induced wind changes.

This test verifies:
1. Both solvers initialize correctly with matching domains
2. Wind field can be solved
3. Fire solver accepts 3D wind field
4. Fire advances and heat sources are extracted
5. Wind solver accepts and stores heat sources
6. Coupled iteration proceeds without errors
"""
