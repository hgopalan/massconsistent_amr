# Gaussian Hill Wind Solver Test with WENO5 Derivatives
# Tests: terrain-following mass-consistent wind on a Gaussian hill using WENO-5 derivatives
...
# Derivative computation method: use WENO-5 instead of central differences
deriv_method = weno5
