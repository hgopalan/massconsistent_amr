# Gaussian Puff Model - Canopy Effects Test
# Tests canopy-enhanced diffusivity and deposition
# Domain: 300m x 300m x 100m
# Source: at canopy height (20m)
# Canopy: Uniform forest 20m tall
# Wind: 10 m/s from west

# Enable puff model
enable_puff = true

# Source location and emission (at canopy top)
source_x  = 100.0      # Source x-coordinate [m]
source_y  = 150.0      # Source y-coordinate [m]
source_z  = 20.0       # Source height [m] (at canopy top)
...
canopy_height = 20.0                 # Canopy height [m]
frontal_area_index = 0.25            # Frontal area index
canopy_enhancement_factor = 3.0      # Vertical diffusivity enhancement (3x)
canopy_sheltering_factor = 0.7       # Horizontal diffusivity reduction (0.7x)

# Canopy deposition (for particles/aerosols)
...
# Output file
puff_output = puff_concentration_canopy.csv  # Output file prefix
