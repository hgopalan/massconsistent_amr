# Uniform Wind Field Test
# Tests: terrain-following mass-consistent wind using uniform initialization mode
# Terrain: 11x11 grid over a 300x300 m domain, peak elevation 50 m at centre

# Terrain file
terrain_file = terrain.csv

# Initialization mode: "uniform" uses constant wind everywhere (independent of height)
init_mode = uniform
uniform_U = 8.5
uniform_V = 2.0
