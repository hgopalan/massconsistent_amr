...
.. list-table::
   ...
   * - Feature
     ...
     - Header File
   * - Atmospheric stability
     - Monin-Obukhov similarity theory (Businger-Dyer); adaptive model selection using bulk Richardson number (Ri_b)
     - ``stability_models.H``
   * - Thermal buoyancy
   ...
   * - Canopy drag
     ...
     - ``canopy_models.H``
   * - Building wakes
     - Röckle, Huber-Snyder, and AERMOD PRIME wake models; adaptive superposition with weighted blending
     - ``wake_models.H``
   * - Slope flows
