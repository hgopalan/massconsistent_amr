...
.. list-table::
   ...
   * - L_u
     - 200-500 m
     - 300 m
     - Integral length scale (u-component)
   * - L_v
     - 140-350 m
     - 210 m
     - Integral length scale (v-component, ≈0.7*L_u)
   * - L_w
     - 80-200 m
     - 120 m
     - Integral length scale (w-component, ≈0.4*L_u)
   * - σ²_u
     - 0.5-2.0
     - 1.0
     - u-component variance
   * - σ²_v
     - 0.3-1.3
     - 0.64
     - v-component variance (≈0.8²*σ²_u)
   * - σ²_w
     - 0.1-0.5
     - 0.25
     - w-component variance (≈0.5²*σ²_u)
   * - α
     - 0.8-2.0
     - 1.0
     - Asymmetry parameter (anisotropy)
   * - η_ij
     - 0.4-0.8
     - varies
     - Coherence factors
