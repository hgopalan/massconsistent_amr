...
.. list-table::
   ...
   * - Phase
     ...
     - Status
   * - **3**
     - ✓ 10/10 tests pass, Realizability 100%, GPU-ready
     - ✓ COMPLETE
   * - **4**
     - ✓ Richardson classification correct, Stability profiles match, 30/30 tests pass, GPU-verified
     - ✓ COMPLETE
   * - **5**
     - Ridge/valley validation, >30° slopes supported
     - PENDING
   * - **6**
     - Presets ±5% accurate, Sensitivity analysis works
     - PENDING
   * - **7**
     - Validation plots publication-ready, Docs complete
     - PENDING
   * - **8**
     - GPU speedup >10×, Edge cases handled
     - PENDING
