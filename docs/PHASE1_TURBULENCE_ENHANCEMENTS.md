...
| Category | Reference Intensity | Typical Site |
|----------|-------------------|--------------|
| A (16%) | 0.16 @ hub | Very turbulent sites |
| B (14%) | 0.14 @ hub | Normal sites |
| C (12%) | 0.12 @ hub | Low-turbulence sites |
...
| Model | Coherence Value | Use Case |
|-------|-----------------|----------|
| Gaussian | ~0.0000 | Smooth, uniform sites |
| Exponential | 0.4493 | General atmospheric boundary layer |
| QuadraticExponential | ~0.0000 | Complex terrain (rapid decay) |
| PowerLaw | 0.4141 | Rough terrain (slow decay) |
...
| Exponent | Characteristics | Site Type |
|----------|-----------------|-----------|
| 0.05 | Gentle, slow growth | Smooth water/urban |
| 0.14 | Moderate growth | Typical terrain |
| 0.20 | Rapid growth | Very rough terrain |
...
|-------------|--------|-----------|
| Category A (16% @ hub) | ✓ | Correctly scaled |
| Category B (14% @ hub) | ✓ | Correctly scaled |
| Category C (12% @ hub) | ✓ | Correctly scaled |
| Power-law exponent 0.2 | ✓ | Implemented |
| Height-dependent scaling | ✓ | Monotonic increase |
| Physical bounds [0.01, 0.30] | ✓ | Enforced |

### Coherence Models

| Model | Range | Monotonicity | Physical |
|-------|-------|--------------|----------|
| Gaussian | [0, 1] | Decreasing | ✓ |
| Exponential | [0, 1] | Decreasing | ✓ |
| QuadraticExponential | [0, 1] | Decreasing | ✓ |
| PowerLaw | [0, 1] | Decreasing | ✓ |

### Smooth Profile

| Property | Validation |
|----------|-----------|
| Monotonicity | Verified for exponents 0.05-0.25 |
| C^∞ smoothness | Proven mathematically |
| Bounds enforcement | Clamped to [0.01, 0.30] |
| Physical realizability | Confirmed for all test cases |
