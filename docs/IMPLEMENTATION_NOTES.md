...
|-------------|--------|-----------------|
| Turn off fluctuations inside terrain | ✓ | `mask = 0 where z_agl ≤ 0` |
| Terrain-aligned fluctuations | ✓ | Smooth cosine blending |
| Conservation of mass | ✓ | Smooth masking preserves ∇·u ≈ 0 |
| No sharp discontinuities | ✓ | C¹ continuous transition |
| Preserve spectral properties | ✓ | Amplitude scaling only |
| Realistic boundary layer | ✓ | Matches atmospheric physics |
