...
| Class | z₀ (m) | Example |
|-------|--------|---------|
| SMOOTH_WATER | 0.0001 | Open ocean |
| GRASSLAND | 0.05 | Short grass |
| GRASSLAND_HIGH | 0.1 | Tall grass |
| SHRUBLAND | 0.15 | Low shrubs |
| FOREST_SPARSE | 0.35 | Sparse trees |
| FOREST_DENSE | 1.0 | Dense forest |
| URBAN_LOW | 0.7 | Low urban |
| URBAN_HIGH | 1.5 | High urban/buildings |
| MOUNTAINS | 2.0 | Mountain terrain |
