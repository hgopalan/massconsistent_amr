...
This section details the physical models, numerical formulations, and validated capabilities of the **Mann Box Model** for synthetic turbulence generation in the mass-consistent wind solver.
...
.. toctree::
   :maxdepth: 2
   :caption: Mann Box Guides & Analyses:
