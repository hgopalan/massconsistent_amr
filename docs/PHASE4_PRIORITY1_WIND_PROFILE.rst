...
.. list-table::
   ...
   * - Feature
     - Capability
   * - Wind Profile Model
     - Full Monin-Obukhov log-law with stability
   * - Stability Functions
     - Businger-Dyer, Holtslag-De Bruin, Paulson
   * - Wind Shear
     - Computed from profile derivatives
   * - Friction Velocity
     - Recovered from reference wind
   * - Height Range
     - Any z > z₀ (roughness length)
   * - Stability Regimes
     - Stable, unstable, neutral
   * - GPU Ready
     - Yes (via existing Phase 3 framework)
...
.. list-table::
   ...
   * - Stable Wind Profile
     - Nighttime winds
     - L = 100m
   * - Unstable Wind Profile
     - Daytime heating
     - L = -100m
   * - Friction Velocity Consistency
     - Robustness check
     - Multiple heights
   * - Businger-Dyer vs Holtslag
     - Parameterization comparison
     - Both models
   * - Wind Shear Properties
...
.. list-table::
   ...
   * - Operation
     - Time
     - GPU Ready
   * - Single profile (10 heights)
     - <1 ms
     - Yes
   * - 100-height profile
     - ~10 ms
     - Yes
   * - Wind shear derivatives
     - <0.1 ms
     - Yes
   * - Full computation
     - 10-50 ms
