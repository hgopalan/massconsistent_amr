# Case 4: Yoshie Below-Roof - Yoshie Two-Layer Model (Below-Roof Level)
# Yoshie model at z < H: backward-compatible cavity behavior
...
# Output files
plot_file = plt_case4_yoshie_below
extract_agl = 15.0
extract_file = case4_yoshie_below.csv

# Yoshie two-layer model enabled (below-roof extraction)
