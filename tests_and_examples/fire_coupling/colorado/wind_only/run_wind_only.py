#!/usr/bin/env python3
"""
run_wind_only.py - Run wind-only scenario (Colorado)

This script demonstrates running the wind solver independently
without fire coupling for the Colorado high-elevation terrain scenario.

Wind Conditions:
- 8 m/s westerly wind at 10m reference height
- Powerlaw profile with exponent 0.2
- Domain: 10x10 km, resolution 64m horizontal, 8m vertical
- Terrain: SRTM-based Colorado mountains
...
def main():
    ...
    print("\n" + "="*70)
    print("WIND-ONLY SCENARIO: COLORADO")
    print("="*70 + "\n")
    ...
    print("Terrain:         SRTM-based mountains (2100-2400m)")
    ...
    print("  Reference speed:   8.0 m/s")
    print("  Direction:         Westerly (U=8, V=0)")
    print("  Profile type:      Powerlaw (α=0.2)")
    print("  Surface roughness: z0=0.1m")
    print()
