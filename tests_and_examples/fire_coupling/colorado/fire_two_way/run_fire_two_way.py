#!/usr/bin/env python3
"""
run_fire_two_way.py - Run two-way fire coupling scenario (Colorado)
...
Colorado Scenario:
- High-elevation terrain (2100-2400m)
- 8 m/s westerly wind
...
def main():
    ...
    print("\n" + "="*70)
    print("TWO-WAY FIRE COUPLING: COLORADO")
    ...
    print("-" * 70)
    print("Location:        Southern Colorado (high elevation)")
    ...
    print("  Speed:    8.0 m/s westerly at 10m height")
    ...
    try:
        ...
        print()
        print("Post-processing available in:")
        print("  - ../postprocessing/wind_speed_at_flame_height.py")
        print("  - ../postprocessing/fire_ros_analysis.py")
        print()
        print("Comparison with one-way coupling:")
        print("  - Wind speeds may be higher due to updrafts")
        print("  - ROS may be different due to wind modifications")
        print("  - Fire-wind interaction creates feedback loops")
        print()
