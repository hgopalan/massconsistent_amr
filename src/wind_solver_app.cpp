...
void WindSolverApp::parse_inputs() {
    ...
    pp.query("scm_heat_flux", scm_heat_flux);
    pp.query("scm_monin_obukhov_length", scm_monin_obukhov_length);
...
void WindSolverApp::initialize_wind_fields(int time_step) {
    ...
    if (init_mode == "loglaw" || init_mode == "deaves_harris" || init_mode == "powerlaw_above_bl") {
        ...
        auto [ug, vg] = SCMModels::find_geostrophic_wind_1d_scm(
            ...
            scm_heat_flux, scm_monin_obukhov_length, 0.05, 20, scm_turbulence_model,
            scm_enable_microphysics, scm_initial_humidity);
        ...
        SCMModels::initialize_1d_state(scm_state, ug, vg, scm_ref_temperature, 
                                       ...
                                       scm_heat_flux, scm_monin_obukhov_length, scm_turbulence_model,
                                       scm_enable_microphysics, scm_initial_humidity);
